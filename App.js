  ...
  render(){                               // as default drawer does not have buttons
    return (
      <DrawerContentScrollView {...this.props}>
        <View style={{flexDirection: 'row',marginTop: 60, marginLeft: 8,marginBottom: 10}}>
            <Avatar.Image theme={avatarTheme}
                  source={require('./MainAppPages/images/pdc_online_icon.png')}
                  size={60}
            />
          <Text style={{color:'#E9446A',fontSize: 20,marginTop: 5, marginHorizontal: '6%',fontWeight:'bold',alignSelf:'center'}}>PDC Online</Text>
...
class AppStack extends React.Component {    // Stack of all screens for navigating in app
  render(){
    return(
      <stack.Navigator initialRouteName="" /* Intital screen is set to our login screen */ >  
